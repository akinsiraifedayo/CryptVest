  ...
  (function () {
    ...
    if (cancelSubscription) {
      cancelSubscription.onclick = function () {
        Swal.fire({
          text: 'Are you sure you would like to delete this wallet and generate a new one?',
          icon: 'warning',
          ...
          if (result.value) {
            Swal.fire({
              icon: 'success',
              title: 'Generated!',
              text: 'Your wallet generation is in progress. Tap ok but do not leave the page.',
              customClass: {
            ...
            Swal.fire({
              title: 'Cancelled',
              text: 'New Wallet Generation Cancelled!!',
              icon: 'error',
              customClass: {
                confirmButton: 'btn btn-success'
              }
